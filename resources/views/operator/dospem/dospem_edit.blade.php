            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 text-center mt-3">
                        ...
                        @else
                        <a href="{{Storage::url($results->foto)}}" class="text-decoration-none" target="_blank">
                            <img src="{{Storage::url($results->foto)}}" class="rounded-circle shadow" alt="Profil" width="100px">
                        </a>
                        @endif
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="flag" class="form-control">
                                        <option value="0" @if ($results->user['flag'] == 0)
                                            selected
                                            @endif
                                            >Aktif</option>
                                        <option @if ($results->user['flag'] == 1)
                                            selected
                                            @endif
