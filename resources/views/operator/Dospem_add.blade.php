            ...
            <div class="col-md-6 ">
                <form method="POST" action="{{route('dospem.store')}}" >
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-text h7 text-primary">Jika Tidak Memiliki Jabatan, Lewati Saja!</p>
                        @error('jabatan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="border-top">
                        ...
                        {{-- <div class="card-body float-left">
                            <a href="{{route('dospem.index')}}" class="btn btn-warning"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                        </div> --}}
                    </div>
