            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 text-center mt-3">
                        ...
                        @endif
                        <h4 class="mt-2 text-primary font-weight-bold">{{$item[0]->nm_mhs}}</h4>
                    </div>
                </div>
                <form class="form-horizontal" method="POST" action="{{route('mahasiswa.foto-update',$item[0]->npm)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row justify-content-center">
