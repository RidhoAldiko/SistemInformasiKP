...
<div class="row justify-content-center">
    ...
    <div class="col-sm-10 col-md-10">
        ...
        <div class="card shadow mb-5 ">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="{{route('dosen.password-update',$item[0]->email)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                <div class="border-top py-2">
                                    <div class="float-right">
                                        <button type="submit" style="background-color: #f0ad4e; border-color: #f0ad4e;" class="btn btn-primary " onclick="return confirm('Apakah Anda Ingin Menyimpan Data Ini?');"><i class="fas fa-save"></i> Simpans</button>
                                    </div>
                                </div>
                            </div>
                        </div>
